...
DEMO_AUTH_USERNAME=${DEMO_AUTH_USERNAME_VALUE}
DEMO_AUTH_PASSWORD=${DEMO_AUTH_PASSWORD_VALUE}
DEMO_AUTH_ROLE=${DEMO_AUTH_ROLE_VALUE}
EOF
}
...
Proxy trust: ${TRUST_PROXY_VALUE}
Cookie secure mode: ${COOKIE_SECURE_VALUE}

Notes:
- Existing .env is preserved unless FORCE_OVERWRITE_ENV=1 is set.
- Set a real SESSION_SECRET_VALUE and credentials before exposing the app publicly.
